...
function MusicalDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        // (API 2개 동시 호출)
        const musicalApiUrl = `https://ticket-distribute-ver.onrender.com/api/musicals/${musicalId}`;
        const performanceApiUrl = `https://ticket-distribute-ver.onrender.com/api/performances/musical/${musicalId}`;
